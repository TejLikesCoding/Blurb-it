...
class GUI:
    ...
    def output_page(self):
        ...
        if book_data:
            ...
            #display rating
            self.rating_label = tk.Label(self.root, text=f"Rating: {rating}", font=("Helvetica", 18))
            ...
            self.summary_button.pack(side=tk.TOP, padx=20, pady=(10, 0))

            # Dropdown for Reviews
            self.reviews_var = tk.StringVar()
            self.reviews_menu = tk.OptionMenu(self.root, self.reviews_var, "Reviews", "Good Review 1", "Good Review 2", "Bad Review 1", "Bad Review 2", command=self.show_review)
            self.reviews_menu.pack(side=tk.TOP, padx=20, pady=(10, 0))
            ...
            self.book_reviews = {'Good Review 1': good_review1, 'Good Review 2': good_review2, 'Bad Review 1': bad_review1, 'Bad Review 2': bad_review2}
